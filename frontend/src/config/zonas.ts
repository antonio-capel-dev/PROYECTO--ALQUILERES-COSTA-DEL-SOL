...
// Mapa curado: slug → ruta local de imagen de zona
export const IMAGENES_ZONA: Record<string, string> = {
  ...
  estepona:     "/images/zonas/estepona.webp",
};

export const IMAGEN_ZONA_FALLBACK = "/images/zonas/placeholder.webp";
...
export const FALLBACKS_PROPIEDAD = [
  ...
  "/images/propiedades/prop-4.webp",
];
